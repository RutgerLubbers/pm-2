...
import nl.hoepsch.pm.model.Fields;
 ...
 */
@Component
public class GasYtdUsageAccumulator implements RecordConsumer, InitializingBean {

    /**
     * The logger to use.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(GasYtdUsageAccumulator.class);
     ...
     */
    @Autowired
    public GasYtdUsageAccumulator(final GasMeterReadoutAssembler gasMeterReadoutAssembler,
